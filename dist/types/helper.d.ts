...
export declare const signAndSendTransaction: (
...
export declare const createBtcService: (
...
export declare function getAddressCellDeps(
  isMainnet: boolean,
  ckbAddresses: string[],
): Promise<CKBComponents.CellDep[]>;
export declare function calculateWitnessSize(
  address: string,
  isMainnet: boolean,
): number;
export {};
